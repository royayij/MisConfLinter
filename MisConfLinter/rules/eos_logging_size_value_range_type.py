...
class ValueRangeTypeRule(AnsibleLintRule):
    ...
    description = 'Value  must be in valid Range. See https://docs.ansible.com/ansible/latest/collections/arista/eos/eos_logging_module.html for more details'
    tags = ['Illegal Value']
    param_value_ranges ={'between': (10, 2147483647)}

    param_type = int

    _modules = ['eos_logging']
